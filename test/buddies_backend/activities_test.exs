defmodule BuddiesBackend.ActivitiesTest do
  ...
  describe "activities" do
    ...
    test "create_activity/1 with valid data creates a activity" do
      valid_attrs = %{description: "some description", title: "some title", start_date: ~U[2025-05-01 23:00:00Z], end_date: ~U[2025-05-01 23:00:00Z]}
      ...
      assert activity.start_date == ~U[2025-05-01 23:00:00Z]
      assert activity.end_date == ~U[2025-05-01 23:00:00Z]
    end
    ...
    test "update_activity/2 with valid data updates the activity" do
      activity = activity_fixture()
      update_attrs = %{description: "some updated description", title: "some updated title", start_date: ~U[2025-05-02 23:00:00Z], end_date: ~U[2025-05-02 23:00:00Z]}
      ...
      assert activity.start_date == ~U[2025-05-02 23:00:00Z]
      assert activity.end_date == ~U[2025-05-02 23:00:00Z]
    end
