defmodule BuddiesBackend.Accounts.User do
  ...
  def login_status_changeset(user, attrs) do
    user
    |> cast(attrs, [:first_time_login])
    |> validate_required([:first_time_login])
  end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, BuddiesBackend.Repo)
  ...
  """
  def valid_password?(%BuddiesBackend.Accounts.User{hashed_password: hashed_password}, password)
