defmodule BuddiesBackend.Accounts do
  @moduledoc """
  ...
  alias BuddiesBackend.Accounts.{User, UserToken, UserNotifier}
  ...
  def update_user_first_login(user) do
    User.login_status_changeset(user, %{first_time_login: false})
    |> Repo.update()
  end
